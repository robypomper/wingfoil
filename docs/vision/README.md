...
|---|---|---|---|---|---|
| [`0_product-brief.md`](0_product-brief.md) | 1.2 | 2026-06-23 | Approved | 306 | Executive summary: vision, problem, pillars, differentiators, personas, metrics, GTM, timeline, tech stack, constraints |
| [`1A_product-vision.md`](1A_product-vision.md) | 1.1 | 2026-06-24 | Approved | 102 | Vision statement, key decisions, and the reference-workflow/methodology-template model |
| [`1B_is-isnot.md`](1B_is-isnot.md) | 1.2 | 2026-06-24 | Approved | 55 | Scope boundaries: what WingFoil IS / IS NOT / DOES / DOES NOT |
| [`2_personas.md`](2_personas.md) | 1.0 | 2026-06-15 | Approved | 112 | The 6 personas (Alex, Sam, Jordan, Morgan, Casey, Taylor) with pains and goals |
| [`3_journeys.md`](3_journeys.md) | 1.2 | 2026-06-24 | Approved | 285 | 8 end-to-end user journeys (0a, 0b, 1–6): steps, obstacles, success |
| [`4_features.md`](4_features.md) | 1.2 | 2026-06-24 | Approved | 508 | 63 features (by pillar + by release) and the data-model / implementation notes |
| [`5A_sequencer.md`](5A_sequencer.md) | 1.3 | 2026-06-24 | Approved | 345 | 5-week delivery timeline, per-release Definition of Done, risks |
| [`5B_mvp-canvas.md`](5B_mvp-canvas.md) | 1.1 | 2026-06-24 | Approved | 193 | MVP canvas: problem/solution/value, target users, metrics, success criteria |
...
| [`X_coherence-audit.md`](X_coherence-audit.md) | 0.1 | 2026-06-25 | Complete | 311 | Meta/process: cross-doc + intra-doc coherence audit (SoT map, findings ledger, decisions) |
...
### `1A_product-vision.md`
- Vision Statement — L9–19
- Key Decisions — L20–30
- Reference Workflows & Methodology Templates — L31–102 (Supported Templates L37, How it works L47, Main vs Sub L62, Benefits L70, Example: Scrum L77)
...
- Key Implementation Notes — L347–508 (State Deduction L349, `memory.yaml` schema L361, Workflow Kinds/Composition L391, Fallback L412, Team & Approval Routing L422, Git Ops L439, Built-in Directive Templates L459, Agent Roles L473, Complexity/Risk/Priority ratings L490)
...
- **Storage layout:** `.wingfoil/{memory.yaml, dna.yaml, workflows.yaml}` + dirs `.wingfoil/{memory,directives,workflows}/`.
